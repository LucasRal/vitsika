...
CONTEXT = (
    ...
    "black-box pipeline actually relies on. We ran it on our own pipeline to "
    "ask the question the accuracy numbers cannot answer: when the classifier "
    "names a genus, is it looking where a taxonomist would? Maps are qualitative - the blob scale is one cell "
